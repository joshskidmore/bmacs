...
#+BEGIN_SRC emacs-lisp
(defvar bmacs-font (font-spec :family "SFMono" :size 24))
#+END_SRC
...
(use-package counsel-dash
  ...
  (add-hook 'c++-mode-hook (lambda () (setq-local counsel-dash-docsets '("C++"))))
  (add-hook 'js2-mode-hook (lambda () (setq-local counsel-dash-docsets '("JavaScript" "AWS_JavaScript"))))
  (add-hook 'js-mode-hook (lambda () (setq-local counsel-dash-docsets '("JavaScript" "AWS_JavaScript"))))
